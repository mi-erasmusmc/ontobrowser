...
CREATE TABLE `VERSION` (
  ...
  `CREATED_DATE` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CREATED_BY` double(12,0) unsigned NOT NULL,
...
CREATE TABLE `CTRLD_VOCAB` (
  ...
  KEY `CTRLD_VOCAB_DATASOURCE_FK_idx` (`DATASOURCE_ID`),
  KEY `CTRLD_VOCAB_DOMAIN_FK_idx` (`CTRLD_VOCAB_DOMAIN_ID`),
  KEY `CTRLD_VOCAB_CONTEXT_FK_idx` (`CTRLD_VOCAB_CONTEXT_ID`),
  KEY `CTRLD_VOCAB_CREATED_BY_FK_idx` (`CREATED_BY`),
  KEY `CTRLD_VOCAB_MODIFIED_BY_FK_idx` (`MODIFIED_BY`),
...
CREATE TABLE `RELATIONSHIP_TYPE` (
  ...
  `IS_TRANSITIVE` bit(1) NOT NULL DEFAULT 1,
...
CREATE TABLE `TERM_XREF` (
  ...
  `IS_DEFINITION_XREF` bit(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `TERM_RELATIONSHIP` (
  ...
  `RELATIONSHIP_TYPE_ID` double(12,0) NOT NULL,
  `IS_INTERSECTION` bit(1) DEFAULT 0,
