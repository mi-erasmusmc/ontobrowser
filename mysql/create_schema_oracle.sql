...
SELECT * FROM lessons.CURATOR_APPROVAL_WEIGHT;
...
SELECT * FROM lessons.DATASOURCE;
...
SELECT * FROM lessons.CTRLD_VOCAB_DOMAIN;
...
CREATE TABLE `CTRLD_VOCAB` (
  ...
  CONSTRAINT `CTRLD_VOCAB_CREATED_BY_FK` FOREIGN KEY (`CREATED_BY`) REFERENCES `CURATOR` (`curator-id`),
  ...
  CONSTRAINT `CTRLD_VOCAB_MODIFIED_BY_FK` FOREIGN KEY (`MODIFIED_BY`) REFERENCES `CURATOR` (`curator-id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `RELATIONSHIP_TYPE` (
  ...
  `IS_TRANSITIVE` bit(1) NOT NULL DEFAULT b'1',
  ...
  CONSTRAINT `RELSHIP_TYPE_CREATED_BY_FK` FOREIGN KEY (`CREATED_BY`) REFERENCES `CURATOR` (`curator-id`),
...
SELECT * FROM lessons.RELATIONSHIP_TYPE;
...
CREATE TABLE `TERM_SYNONYM` (
  ...
  CONSTRAINT `TERM_SYNON_CREATED_BY_FK` FOREIGN KEY (`CREATED_BY`) REFERENCES `CURATOR` (`curator-id`),
...
CREATE TABLE `CURATOR_ACTION` (
  ...
  CONSTRAINT `CURATOR_ACTION_CURATOR_FK` FOREIGN KEY (`CURATOR_ID`) REFERENCES `CURATOR` (`curator-id`),
